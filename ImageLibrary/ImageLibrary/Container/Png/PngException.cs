...
namespace ImageLibrary.Container.Png;
...
public class PngException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PngException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
