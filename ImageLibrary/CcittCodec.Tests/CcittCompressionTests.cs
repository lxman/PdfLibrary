...
namespace CcittCodec.Tests
{
    public class CcittCompressionTests
    {
        ...
        public void Group4_RoundTrip_AllWhite()
        {
            ...
            byte[] compressed = CompressGroup4(original, width, height);
            byte[] decompressed = DecompressGroup4(compressed, width, height);
        ...
        public void Group4_RoundTrip_AlternatingRows()
        {
            var width = 64;
            var height = 10;
            byte[] original = CreateTestBitmap(width, height, true);
        ...
        public void Group4_RoundTrip_VerticalStripes()
        {
            var width = 64;
            var height = 10;
            byte[] original = CreateStripedBitmap(width, height, 8);
        ...
        public void Group3_1D_RoundTrip_AllWhite()
        {
            ...
            byte[] compressed = CompressGroup3_1D(original, width, height);
            byte[] decompressed = DecompressGroup3_1D(compressed, width, height);
        ...
        {
            CcittOptions options = CcittOptions.FromPdfK(-1, 1728);
        ...
        {
            CcittOptions options = CcittOptions.FromPdfK(0, 1728);
        ...
        {
            CcittOptions options = CcittOptions.FromPdfK(4, 1728);
