...
{
    /// <summary>
    /// Standard Macintosh glyph ordering for TrueType 'post' table format 2.0
    /// Indices 0-257 are standard names, 258+ are custom names in the font
    /// Based on Apple TrueType specification
    /// </summary>
    internal static class MacintoshGlyphNames
    {
