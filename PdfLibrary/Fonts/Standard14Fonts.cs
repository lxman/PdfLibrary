    ...
    public static IReadOnlyList<string> SubstituteFileBaseNames(string baseFontName)
    {
        ...
        return family switch
        {
            ...
            Family.Serif => Pick(bold, italic,
                ["times", "LiberationSerif-Regular", "NimbusRoman-Regular", "Tinos-Regular", "Times", "DejaVuSerif"],
                ["timesbd", "LiberationSerif-Bold", "NimbusRoman-Bold", "Tinos-Bold", "Times", "DejaVuSerif-Bold"],
                ["timesi", "LiberationSerif-Italic", "NimbusRoman-Italic", "Tinos-Italic", "Times", "DejaVuSerif-Italic"],
                ["timesbi", "LiberationSerif-BoldItalic", "NimbusRoman-BoldItalic", "Tinos-BoldItalic", "Times", "DejaVuSerif-BoldItalic"]),
            Family.Mono => Pick(bold, italic,
                ["cour", "LiberationMono-Regular", "NimbusMonoPS-Regular", "Cousine-Regular", "Courier", "DejaVuSansMono"],
                ["courbd", "LiberationMono-Bold", "NimbusMonoPS-Bold", "Cousine-Bold", "Courier", "DejaVuSansMono-Bold"],
                ["couri", "LiberationMono-Italic", "NimbusMonoPS-Italic", "Cousine-Italic", "Courier", "DejaVuSansMono-Oblique"],
                ["courbi", "LiberationMono-BoldItalic", "NimbusMonoPS-BoldItalic", "Cousine-BoldItalic", "Courier", "DejaVuSansMono-BoldOblique"]),
